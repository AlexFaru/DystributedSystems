...
public class LeaderElection implements Watcher {
    ...
    /*public void creatParent() throws  KeeperException, InterruptedException{
        String parent = zooKeeper.create("", new byte[]{}, ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL_SEQUENTIAL);
    }*/
